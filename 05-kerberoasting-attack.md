...
Kerberoasting is an Active Directory attack technique (MITRE ATT\&CK T1558.003) 

where an attacker requests Kerberos service tickets for service accounts, 

then cracks them offline to reveal plaintext passwords.
